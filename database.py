...
from sqlalchemy import desc, Column, ForeignKey, Integer, String, DateTime, Float
...
def add_data_to_database(session, people):
...
def get_people_born_between_dates(session, date1, date2):
